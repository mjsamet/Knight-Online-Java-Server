...
enum e_ErrorCharacterCreate {	ERROR_CHARACTER_CREATE_SUCCESS = 1,
	ERROR_CHARACTER_CREATE_NO_MORE_CHARACTER = 2,
	ERROR_CHARACTER_INVALID_CHARACTER_POSITION = 3,
	ERROR_CHARACTER_CREATE_INVALID_NAME_HAS_SPECIAL_LETTER = 4,
	ERROR_CHARACTER_CREATE_INVALID_RACE = 5,
	ERROR_CHARACTER_CREATE_INVALID_SPECIALITY = 6,
	ERROR_CHARACTER_CREATE_INVALID_NATION_AND_INVALID_RACE = 7,
	ERROR_CHARACTER_CREATE_INVALID_STAT_POINT = 8,
	ERROR_CHARACTER_CREATE_OVERLAPPED_ID = 9,
	ERROR_CHARACTER_CREATE_SERVER_ERROR = 10,
